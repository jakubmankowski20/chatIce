...
class Callback_User_ChangePassword_Base : virtual public ::IceInternal::CallbackBase { };
...
class Callback_Server_FindUser_Base : virtual public ::IceInternal::CallbackBase { };
...
class Callback_Server_removeUser_Base : virtual public ::IceInternal::CallbackBase { };
...
public:
    ...
    void SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message)
    {
        SendMessage(__p_roomName, __p_who, __p_message, 0);
    }
    void SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx)
    {
        SendMessage(__p_roomName, __p_who, __p_message, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Chat::Callback_User_SendMessagePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::std::string& __p_roomName, const ::Chat::UserPrx& __p_who, const ::std::string& __p_message, const ::Ice::Context& __ctx, const ::Chat::Callback_User_SendMessagePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SendMessage(__p_roomName, __p_who, __p_message, &__ctx, __del, __cookie);
    }
...
public:
    ...
    void ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword)
    {
        ChangePassword(__p_oldpassword, __p_newpassword, 0);
    }
    void ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context& __ctx)
    {
        ChangePassword(__p_oldpassword, __p_newpassword, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_ChangePassword(__p_oldpassword, __p_newpassword, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    ...
    {
        return __begin_ChangePassword(__p_oldpassword, __p_newpassword, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context* __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context& __ctx)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Chat::Callback_User_ChangePasswordPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string& __p_oldpassword, const ::std::string& __p_newpassword, const ::Ice::Context& __ctx, const ::Chat::Callback_User_ChangePasswordPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_ChangePassword(__p_oldpassword, __p_newpassword, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void ChangePassword(const ::std::string&, const ::std::string&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_ChangePassword(const ::std::string&, const ::std::string&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    ::Chat::UserPrx FindUser(const ::std::string& __p_name)
    {
        return FindUser(__p_name, 0);
    }
    ::Chat::UserPrx FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx)
    {
        return FindUser(__p_name, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_FindUser(const ::std::string& __p_name, const ::IceInternal::Function<void (const ::Chat::UserPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_FindUser(__p_name, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_FindUser(const ::std::string& __p_name, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_FindUser(__p_name, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Chat::UserPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_FindUser(__p_name, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_FindUser(__p_name, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_FindUser(const ::std::string& __p_name, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Chat::UserPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name)
    {
        return begin_FindUser(__p_name, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx)
    {
        return begin_FindUser(__p_name, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_FindUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_FindUser(__p_name, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name, const ::Chat::Callback_Server_FindUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_FindUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string& __p_name, const ::Ice::Context& __ctx, const ::Chat::Callback_Server_FindUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_FindUser(__p_name, &__ctx, __del, __cookie);
    }
...
private:
    ...
    ::Chat::UserPrx FindUser(const ::std::string&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_FindUser(const ::std::string&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    void RegisterUser(const ::Chat::UserPrx& __p_name)
    {
        RegisterUser(__p_name, 0);
    }
    void RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx)
    {
        RegisterUser(__p_name, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_RegisterUser(__p_name, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_RegisterUser(__p_name, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_RegisterUser(__p_name, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_RegisterUser(__p_name, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context* __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name)
    {
        return begin_RegisterUser(__p_name, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx)
    {
        return begin_RegisterUser(__p_name, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_RegisterUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_RegisterUser(__p_name, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Chat::Callback_Server_RegisterUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_RegisterUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::Chat::Callback_Server_RegisterUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_RegisterUser(__p_name, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void RegisterUser(const ::Chat::UserPrx&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_RegisterUser(const ::Chat::UserPrx&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    void removeUser(const ::Chat::UserPrx& __p_name)
    {
        removeUser(__p_name, 0);
    }
    void removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx)
    {
        removeUser(__p_name, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_removeUser(const ::Chat::UserPrx& __p_name, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_removeUser(__p_name, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_removeUser(const ::Chat::UserPrx& __p_name, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_removeUser(__p_name, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_removeUser(__p_name, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_removeUser(__p_name, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context* __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name)
    {
        return begin_removeUser(__p_name, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx)
    {
        return begin_removeUser(__p_name, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_removeUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_removeUser(__p_name, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Chat::Callback_Server_removeUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_removeUser(__p_name, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx& __p_name, const ::Ice::Context& __ctx, const ::Chat::Callback_Server_removeUserPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_removeUser(__p_name, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void removeUser(const ::Chat::UserPrx&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_removeUser(const ::Chat::UserPrx&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void ChangePassword(const ::std::string&, const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    virtual ::Chat::UserPrx FindUser(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___FindUser(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void RegisterUser(const ::Chat::UserPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___RegisterUser(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void removeUser(const ::Chat::UserPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& __result) const
    {
        ...
        try
        {
            __ret = __proxy->end_FindUser(__result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(__result, ex);
